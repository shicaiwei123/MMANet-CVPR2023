...
class ESANetOneModality_DAD(nn.Module):
    def __init__(self,
                 height=480,
                 width=640,
                 num_classes=37,
                 ...
                 weighting_in_encoder='None',
                 upsampling='bilinear'):
        super(ESANetOneModality_DAD, self).__init__()
    ...
    def forward(self, image):
        ...
        if self.training:
            out, out_down_8, out_down_16, out_down_32, out_down_8_feature, out_down_16_feature, out_down_32_feature = self.decoder(
                enc_outs=outs)
            return out, out_down_8, out_down_16, out_down_32, out_4, out_3, out_2
        else:
            out, out_down_8_feature, out_down_16_feature, out_down_32_feature = self.decoder(enc_outs=outs)

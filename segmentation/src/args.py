...
class ArgumentParserRGBDSegmentation(argparse.ArgumentParser):
    def set_common_args(self):
        ...
        self.add_argument('--batch_size_valid', type=int, default=3,
        ...
        self.add_argument('--p',default=[0,0])
        self.add_argument('--kd_scale', type=float,default=4.0)
        self.add_argument('--auxi_scale', type=float,default=0.2)
